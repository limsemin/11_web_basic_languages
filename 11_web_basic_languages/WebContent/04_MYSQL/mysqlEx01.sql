...
INSERT INTO MEMBER(		# 특정 컬럼만 데이터를 삽입할 경우
						# 특정 컬럼만 작성한다.
		NUM,
        NAME)
VALUE(
...
# 예시 7) 데이터 수정 쿼리
# ISSUE : SQL에서 UPDATE와 DELETE 구문을 막아 놓아서
# SAFETY UPDATE 옵션을 해제 해야 UPDATE , DELETE문을 사용할 수 있다.
# EDIT > PREPERENCES > SQL EDITOR > SAFETY UPDATE 체크박스 해제
UPDATE 
		MEMBER
SET
		HEIGHT = 191.3,
